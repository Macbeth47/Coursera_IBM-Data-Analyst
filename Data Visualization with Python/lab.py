...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard", style={'textAlign':'center', 'color':'blue'}),#Include style for title
    ...
    html.Div(id='output-container', className='output', style={'padding':'20px'}),])
])
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type', title=f'Advertisement Expenditure by Vehicle Type in {input_year}'))
